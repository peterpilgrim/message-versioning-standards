...
public class CustomEmbeddedActiveMQBrokerExtension implements AfterEachCallback, BeforeEachCallback {
     ...
     */
    public CustomEmbeddedActiveMQBrokerExtension() {
        ...
        try {
            brokerService.addConnector("tcp://localhost:61777");
        } catch (Exception e) {
     ...
     */
    public CustomEmbeddedActiveMQBrokerExtension(String configurationURI) {
        try {
     ...
     * Create an embedded ActiveMQ broker using a configuration URI
     */
    public CustomEmbeddedActiveMQBrokerExtension(URI configurationURI) {
        try {
            brokerService = BrokerFactory.createBroker(configurationURI);
        } catch (Exception ex) {
            throw new RuntimeException("Exception encountered creating embedded ActiveMQ broker from configuration URI: " + configurationURI, ex);
     ...
     * <p/>
     * Invoked by JUnit 5 to set up the resource
     */
    @Override
     ...
     * <p/>
     * Invoked by JUnit 5 to tear down the resource
     */
    @Override
